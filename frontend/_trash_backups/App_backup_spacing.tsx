                ...
                <ResponsiveContainer>
                  {mode === "equity" ? (
                    <AreaChart data={result.equity_curve} margin={{ left: 70, right: 10, top: 10, bottom: 30 }}>
                      ...
                      <XAxis dataKey="date" minTickGap={28} tickMargin={8} stroke="#94a3b8">
                        <Label value="Date" offset={10} position="insideBottom" fill="#94a3b8" />
                      </XAxis>
                    ...
                    <LineChart data={result.price_series ?? []} margin={{ left: 70, right: 10, top: 10, bottom: 30 }}>
                      <CartesianGrid stroke="rgba(148,163,184,0.15)" vertical={false}/>
                      <XAxis dataKey="date" minTickGap={28} tickMargin={8} stroke="#94a3b8">
                        <Label value="Date" offset={10} position="insideBottom" fill="#94a3b8" />
                      </XAxis>
